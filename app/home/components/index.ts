 ...
 * 
 * This file exports all components used specifically on the home page.
 * This follows the separation of concerns principle by organizing
 * home page components in their own dedicated folder.
 */

export { DGCARequirements } from './DGCARequirements';
