          ...
          <ScrollAnimation animationType="fadeInUp" delay={200}>
            <div className="text-center">
              <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-full px-8 py-3 mb-6 shadow-lg border border-blue-200/50">
                ...
                <span className="text-blue-800 text-sm font-semibold">FocusONE Program</span>
              </div>
        ...
        <div className="container-wide relative z-10">
          <ScrollAnimation animationType="fadeInUp" delay={200}>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-full px-8 py-3 mb-6 shadow-lg border border-blue-200/50">
                <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse" />
                <span className="text-blue-800 text-sm font-semibold">Program Features</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">Key Features of our FocusONE</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <ScrollAnimation animationType="fadeInUp" delay={400}>
              <div className="group text-center p-8 bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-blue-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:border-blue-300 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-blue-700 transition-colors duration-300">Individual Live Sessions</h3>
            ...
            <ScrollAnimation animationType="fadeInUp" delay={600}>
              <div className="group text-center p-8 bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-sky-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:border-sky-300 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-sky-700 transition-colors duration-300">Choose Your Time</h3>
                <p className="text-slate-600 text-lg leading-relaxed flex-grow">
            ...
            <ScrollAnimation animationType="fadeInUp" delay={800}>
              <div className="group text-center p-8 bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-emerald-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:border-emerald-300 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-emerald-700 transition-colors duration-300">Additional Learning Material</h3>
                <p className="text-slate-600 text-lg leading-relaxed flex-grow">
            ...
            <ScrollAnimation animationType="fadeInUp" delay={1000}>
              <div className="group text-center p-8 bg-white/90 backdrop-blur-xl rounded-2xl shadow-lg border border-amber-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:border-amber-300 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-amber-700 transition-colors duration-300">Doubt-Clearing Sessions</h3>
                <p className="text-slate-600 text-lg leading-relaxed flex-grow">
        ...
        <div className="container-wide relative z-10">
          <ScrollAnimation animationType="fadeInUp" delay={200}>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-full px-8 py-3 mb-6 shadow-lg border border-blue-200/50">
                <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse" />
                <span className="text-blue-800 text-sm font-semibold">Comprehensive Curriculum</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">Subjects Covered</h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
          ...
          <ScrollAnimation animationType="fadeInUp" delay={300}>
            <div className="mb-12">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 to-sky-500 text-white rounded-full px-8 py-3 shadow-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <ScrollAnimation animationType="scaleIn" delay={400}>
              <div className="group bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-xl border-2 border-blue-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 h-full flex flex-col">
            ...
            <ScrollAnimation animationType="scaleIn" delay={600}>
              <div className="group bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-xl border-2 border-sky-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 h-full flex flex-col relative">
                <div className="relative mb-6">
            ...
            <ScrollAnimation animationType="scaleIn" delay={800}>
              <div className="group bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-xl border-2 border-emerald-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105 h-full flex flex-col">
                <div className="relative mb-6">
          ...
          <ScrollAnimation animationType="fadeInUp" delay={900}>
            <div className="mb-12">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-full px-8 py-3 shadow-lg">
                  <div className="w-3 h-3 bg-white rounded-full animate-pulse" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <ScrollAnimation animationType="fadeInLeft" delay={1000}>
              <div className="group bg-gradient-to-br from-indigo-50 to-blue-50 rounded-3xl p-10 shadow-xl border-2 border-indigo-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105">
                <div className="flex items-start gap-6">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 w-16 h-16 rounded-2xl border-2 border-indigo-400/30 animate-pulse" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-indigo-600 transition-colors duration-300">Technical General</h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="inline-block bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs font-semibold">Aircraft Systems</span>
                      <span className="inline-block bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs font-semibold">Engine Operations</span>
                      <span className="inline-block bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs font-semibold">Flight Principles</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <ScrollAnimation animationType="fadeInRight" delay={1100}>
              <div className="group bg-gradient-to-br from-teal-50 to-cyan-50 rounded-3xl p-10 shadow-xl border-2 border-teal-200/50 hover:shadow-2xl transition-all duration-500 hover:scale-105">
                <div className="flex items-start gap-6">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 w-16 h-16 rounded-2xl border-2 border-teal-400/30 animate-pulse" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-teal-600 transition-colors duration-300">Radio Telephony Restricted (RTR)</h3>
                    <p className="text-slate-700 text-lg leading-relaxed mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="inline-block bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-xs font-semibold">Radio Procedures</span>
                      <span className="inline-block bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-xs font-semibold">ATC Communication</span>
                      <span className="inline-block bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-xs font-semibold">Emergency Protocols</span>
                    </div>
                  </div>
                </div>
              </div>
