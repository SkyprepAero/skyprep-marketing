          ...
          <ScrollAnimation animationType="fadeInUp" delay={200}>
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-8 py-3 mb-6 border border-white/20">
                ...
                <span className="text-white text-sm font-semibold">Foreign License Conversion</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-bold text-white mb-6">Complete DGCA Conversion Support</h2>
              <p className="text-xl text-amber-100 max-w-3xl mx-auto">
                Convert your foreign pilot license to DGCA standards seamlessly
              </p>
            </div>
          </ScrollAnimation>
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/15 transition-all duration-500 hover:scale-105">
                <div className="p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-white">DGCA License Conversion Service</h3>
                      <p className="text-amber-200 font-semibold">FAA, CASA, SACAA, CAANZ, CAAP to DGCA</p>
                      <div className="flex items-center gap-2 text-amber-300 text-sm mt-1">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>4-8 weeks completion</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="flex items-center gap-2 text-amber-200 text-sm">
                          ...
                          <span>License conversion</span>
                        </div>
                        <div className="flex items-center gap-2 text-amber-200 text-sm">
                          <svg className="w-3 h-3 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span>Flying hour completion</span>
                        </div>
                        <div className="flex items-center gap-2 text-amber-200 text-sm">
                          <svg className="w-3 h-3 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                          <span>eGCA documentation</span>
                        </div>
                        <div className="flex items-center gap-2 text-amber-200 text-sm">
                          <svg className="w-3 h-3 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="flex-1 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-6 py-3 rounded-xl font-semibold text-center transition-all duration-200 flex items-center justify-center gap-2 hover:scale-105"
                    >
